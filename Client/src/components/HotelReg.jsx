    ...
    <div className='fixed top-0 bottom-0 left-0 right-0 z-100 flex items-center justify-center bg-black'>
        <form className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
            ...
            <div className='w-full mt-4 max-w-60 mr-auto'>
                <label htmlFor="district" className='font-medium text-gray-500'>District</label>
                <select id="district" className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required>
