...
const NewsLetter = () => {
  return (
    <div className="flex flex-col items-center max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
      <Title
        title="Stay Updated with SnapNest"
        subTitle="Get the latest hotel deals, exclusive offers, and travel tips directly to your inbox."
      />
      ...
      <p className="text-gray-500 mt-6 text-xs text-center">
        By subscribing, you agree to our Privacy Policy and allow us to send you
        exclusive SnapNest deals, travel tips, and special offers to your inbox.
      </p>
    </div>
  );
};
