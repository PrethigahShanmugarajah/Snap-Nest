  ...
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30'>
        <div className='flex flex-col md:flex-row items-center justify-between w-full'>
            <Title align='left' title="Special Deals Await You" subTitle="Enjoy exclusive discounts and personalized packages designed to make your stay truly exceptional."/>
            <button className="group flex items-center gap-2 font-medium cursor-pointer max-md:mt-12">
  See All Deals
  <i className="bi bi-arrow-right group-hover:translate-x-1 transition-all"></i>
</button>
