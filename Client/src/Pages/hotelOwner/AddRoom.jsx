...
const AddRoom = () => {
    ...
    const [inputs, setInputs] = useState({
        ...
        pricePerNight: 0,
        amenities:{
            "Free WiFi": false, "Free Breakfast": false,
            "Room Service": false, "Mountain View": false,
            "Pool Access": false, "Air Conditioning": false,
            "Beach Access": false, "Flat-Screen TV": false,
            "Fitness Center": false, "Laundry Service": false          
        }
    })
    ...
    return (
    <form>
        <Title align="left" font="poppins" title="Add Room" subTitle="Fill in the details to add a new room to your hotel. Provide pricing, amenities, and upload room images for better visibility."/>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 mt-1 text-gray-400 max-w-md'>
